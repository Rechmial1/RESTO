...
class SuperadminPaymentSettings extends Component
{
    ...
    public function setCredentials()
    {
        ...
        $this->fedapayPublicKey = $this->paymentGateway->live_fedapay_public_key ?? null;
        $this->fedapaySecretKey = $this->paymentGateway->live_fedapay_secret_key ?? null;
    ...
    {
        $this->validate([
            'fedapayPublicKey' => Rule::requiredIf($this->fedapayStatus == true && $this->fedapayMode == 'live'),
            'fedapaySecretKey' => Rule::requiredIf($this->fedapayStatus == true && $this->fedapayMode == 'live'),
            'testFedapayPublicKey' => Rule::requiredIf($this->fedapayStatus == true && $this->fedapayMode == 'sandbox'),
            'testFedapaySecretKey' => Rule::requiredIf($this->fedapayStatus == true && $this->fedapayMode == 'sandbox'),
        ]);

        $configError = $this->saveFedapaySettings();
    ...
    private function saveFedapaySettings()
    {
        ...
        try {
            $this->paymentGateway->update([
                ...
                'live_fedapay_public_key' => $this->fedapayPublicKey,
                'live_fedapay_secret_key' => $this->fedapaySecretKey,
