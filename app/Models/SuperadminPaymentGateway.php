...
class SuperadminPaymentGateway extends BaseModel
{
    ...
    public function getFedapayPublicKeyAttribute()
    {
        return ($this->fedapay_mode == 'sandbox' ? $this->test_fedapay_public_key : $this->live_fedapay_public_key);
    }

    public function getFedapaySecretKeyAttribute()
    {
        return ($this->fedapay_mode == 'sandbox' ? $this->test_fedapay_secret_key : $this->live_fedapay_secret_key);
    }
}
