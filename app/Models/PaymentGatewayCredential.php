...
class PaymentGatewayCredential extends BaseModel
{
    ...
    public function getFedapayPublicKeyAttribute($value)
    {
        return $this->fedapay_mode == 'sandbox'
            ? $this->attributes['test_fedapay_public_key'] ?? null
            : $value;
    }

    public function getFedapaySecretKeyAttribute($value)
    {
        return $this->fedapay_mode == 'sandbox'
            ? $this->attributes['test_fedapay_secret_key'] ?? null
            : $value;
    }
