...
Route::post('/fedapay/create/{hash}', [FedapayPaymentController::class, 'createPayment'])->name('fedapay.create');
Route::get('/fedapay/success/{hash}', [FedapayPaymentController::class, 'success'])->name('fedapay.success');
Route::get('/fedapay/cancel/{hash}', [FedapayPaymentController::class, 'cancel'])->name('fedapay.cancel');
Route::post('/fedapay/webhook/{hash}', [FedapayPaymentController::class, 'webhook'])->name('fedapay.webhook');
...
Route::middleware(['auth', config('jetstream.auth_session'), 'verified', VerifyRestaurantAccess::class, CheckRestaurantPackage::class])->group(function () {
    ...
    Route::post('orders/normalise/{id}', [OrderController::class, 'normalise'])->name('orders.normalize');
