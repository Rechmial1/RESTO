        ...
        @else
            ...
            <div
                ...
                @if ($isGlobalFedapayEnabled)
                    <li wire:click="activeSetting('fedapay')" class="me-2">
                        <span @class([
                            ...
                            <span @class([
                                'flex w-3 h-3 me-3 rounded-full',
                                'bg-green-500' => $isFedapayEnabled,
                                'bg-red-500' => ! $isFedapayEnabled,
                            ])></span>
                        </span>
                    </li>
                @endif
                ...
                @if($activePaymentSetting == 'fedapay')
                    <form wire:submit.prevent="submitFormFedapay">
                        <div class="grid gap-6">
                            ...
                            @if ($fedapayStatus)
                                <div>
                                    <x-label for="fedapayMode" :value="__('modules.settings.selectEnvironment')" required/>
